...
const DOCS: Record<string, Doc> = {
  terms: {
    ...
    body: [
      { p: "Bienvenue sur Afylo. En utilisant l'application, tu acceptes les présentes conditions. Merci de les lire attentivement." },
      ...
      { h: '2. Contenu', p: "Tu conserves les droits sur le contenu que tu publies (vidéos, photos, produits). Tu accordes à Afylo une licence pour l'héberger et l'afficher dans l'application. Le contenu illégal, trompeur ou contrefait est interdit." },
      { h: '3. Ventes & paiements', p: "Les ventes réalisées via Afylo (boutiques, lives, affiliation) sont soumises à une commission de 5%. Les paiements et l'escrow XaalisPay visent à sécuriser acheteurs et vendeurs jusqu'à la confirmation de livraison." },
      { h: '4. Affiliation', p: "Un créateur qui revend un produit touche la commission fixée par le vendeur (minimum 15%, dont 5% revient à Afylo). Toute fraude entraîne la suspension." },
      { h: '5. Résiliation', p: "Tu peux désactiver ou supprimer ton compte à tout moment depuis les Paramètres. Afylo peut suspendre un compte en cas de violation des présentes conditions." },
  ...
  privacy: {
    ...
    updated: 'Dernière mise à jour : 2026',
    body: [
      { p: "Afylo respecte ta vie privée. Cette politique explique quelles données nous collectons et comment nous les utilisons." },
      ...
      { h: 'Contact', p: "Pour toute question : support@afylo.app" },
    ],
  },
  about: {
    title: "À propos d'Afylo",
    updated: 'Version 1.0.0',
    body: [
      { p: "Afylo — « Là où l'Afrique crée, vend et gagne. »" },
      { p: "Afylo est le réseau social qui rémunère les créateurs africains : vidéos courtes, lives, boutiques et paiement natif, réunis dans une seule application." },
...
const styles = StyleSheet.create({
  ...
  updated: { ...Type.caption, color: Afylo.textFaint },
  h: { ...Type.body, fontFamily: Font.semibold, color: Afylo.text, marginBottom: 6 },
  p: { ...Type.body, color: Afylo.textDim, lineHeight: 24 },
});
