    ...
    <View style={styles.root}>
      ...
      {loading ? (
        ...
        <View style={styles.empty}>
          <Ionicons name="bookmark-outline" size={34} color={Afryko.textFaint} />
...
const styles = StyleSheet.create({
  ...
  emptyTitle: { color: Afryko.text, fontSize: 16, fontFamily: Font.bold, marginTop: 6 },
  emptySub: { color: Afryko.textDim, fontSize: 13, textAlign: 'center', lineHeight: 19 },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: GAP },
  cell: { width: `${(100 - 2) / 3}%`, aspectRatio: 1, backgroundColor: Afryko.surfaceAlt, overflow: 'hidden' },
